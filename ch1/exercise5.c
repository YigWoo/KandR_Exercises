 ...
 * No input, output is a table that lists the C-F temperature conversion results from 300 to 0 celsius temperature.
 *
 * Author: Yigwoo
 */
...
main() {
  ...
  for (celsiusT = upper; celsiusT >= lower; celsiusT -= step) {
